...
export const NOTIFICATION_EVENTS: {
  ...
  // Отдельное событие, а не расширение attempt_submitted: сдача с ручной
  // проверкой — задача учителю, а полностью авто-проверенная работа —
  // информационное сообщение. Их полезно уметь глушить по отдельности,
  // особенно на больших группах, где вторых приходит по одному на ученика.
  {
    type: 'attempt_auto_checked',
    audience: 'teacher',
