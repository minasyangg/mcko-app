  ...
  public: {
    Tables: {
      ...
      doska_student_boards: {
        ...
        Relationships: [
          {
            foreignKeyName: "doska_student_boards_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "doska_student_boards_teacher_id_fkey"
            columns: ["teacher_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      grade_promotions: {
        ...
        Relationships: [
          {
            foreignKeyName: "grade_promotions_ran_by_fkey"
            columns: ["ran_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      current_school_year: { Args: { at_date?: string }; Returns: number }
      ...
      promote_student_grades: {
        Args: { p_actor?: string; p_force?: boolean }
        Returns: {
          graduated: number
          promoted: number
          skipped_already_done: boolean
        }[]
      }
